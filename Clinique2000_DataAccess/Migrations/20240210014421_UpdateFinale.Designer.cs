...
namespace Clinique2000_DataAccess.Migrations
{
    ...
    [Migration("20240210014421_UpdateFinale")]
    partial class UpdateFinale
    {
            ...
            modelBuilder.Entity("Clinique2000_Models.Models.FileDAttente", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 2,
                            CliniqueId = 1,
                            DateHeureFermeture = new DateTime(2024, 2, 10, 1, 44, 21, 234, DateTimeKind.Local).AddTicks(7379),
                            DateHeureInscriptions = new DateTime(2024, 2, 9, 17, 44, 21, 234, DateTimeKind.Local).AddTicks(7338),
                            DateHeureOuverture = new DateTime(2024, 2, 9, 20, 44, 21, 234, DateTimeKind.Local).AddTicks(7377),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        },
                        new
                        {
                            Id = 3,
                            CliniqueId = 1,
                            DateHeureFermeture = new DateTime(2024, 2, 10, 20, 44, 21, 234, DateTimeKind.Local).AddTicks(7385),
                            DateHeureInscriptions = new DateTime(2024, 2, 10, 17, 44, 21, 234, DateTimeKind.Local).AddTicks(7381),
                            DateHeureOuverture = new DateTime(2024, 2, 10, 20, 44, 21, 234, DateTimeKind.Local).AddTicks(7383),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        },
                        new
                        ...
                        new
                        {
                            Id = 5,
                            CliniqueId = 7,
                            DateHeureFermeture = new DateTime(2024, 2, 10, 1, 44, 21, 234, DateTimeKind.Local).AddTicks(7391),
                            DateHeureInscriptions = new DateTime(2024, 2, 9, 17, 44, 21, 234, DateTimeKind.Local).AddTicks(7388),
                            DateHeureOuverture = new DateTime(2024, 2, 9, 20, 44, 21, 234, DateTimeKind.Local).AddTicks(7390),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        },
                        new
                        {
                            Id = 6,
                            CliniqueId = 7,
                            DateHeureFermeture = new DateTime(2024, 2, 10, 20, 44, 21, 234, DateTimeKind.Local).AddTicks(7395),
                            DateHeureInscriptions = new DateTime(2024, 2, 10, 17, 44, 21, 234, DateTimeKind.Local).AddTicks(7393),
                            DateHeureOuverture = new DateTime(2024, 2, 10, 20, 44, 21, 234, DateTimeKind.Local).AddTicks(7394),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        });
                });
