...
namespace Clinique2000_DataAccess.Migrations
{
    ...
    [Migration("20240208204126_ModSeedCliniques")]
    partial class ModSeedCliniques
    {
            ...
            modelBuilder.Entity("Clinique2000_Models.Models.FileDAttente", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 2,
                            CliniqueId = 1,
                            DateHeureFermeture = new DateTime(2024, 2, 8, 20, 41, 26, 470, DateTimeKind.Local).AddTicks(3981),
                            DateHeureInscriptions = new DateTime(2024, 2, 8, 12, 41, 26, 470, DateTimeKind.Local).AddTicks(3944),
                            DateHeureOuverture = new DateTime(2024, 2, 8, 15, 41, 26, 470, DateTimeKind.Local).AddTicks(3979),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        },
                        new
                        {
                            Id = 3,
                            CliniqueId = 1,
                            DateHeureFermeture = new DateTime(2024, 2, 9, 15, 41, 26, 470, DateTimeKind.Local).AddTicks(3987),
                            DateHeureInscriptions = new DateTime(2024, 2, 9, 12, 41, 26, 470, DateTimeKind.Local).AddTicks(3983),
                            DateHeureOuverture = new DateTime(2024, 2, 9, 15, 41, 26, 470, DateTimeKind.Local).AddTicks(3985),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        },
                        new
                        ...
                        new
                        {
                            Id = 5,
                            CliniqueId = 7,
                            DateHeureFermeture = new DateTime(2024, 2, 8, 20, 41, 26, 470, DateTimeKind.Local).AddTicks(3993),
                            DateHeureInscriptions = new DateTime(2024, 2, 8, 12, 41, 26, 470, DateTimeKind.Local).AddTicks(3990),
                            DateHeureOuverture = new DateTime(2024, 2, 8, 15, 41, 26, 470, DateTimeKind.Local).AddTicks(3992),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        },
                        new
                        {
                            Id = 6,
                            CliniqueId = 7,
                            DateHeureFermeture = new DateTime(2024, 2, 9, 15, 41, 26, 470, DateTimeKind.Local).AddTicks(3999),
                            DateHeureInscriptions = new DateTime(2024, 2, 9, 12, 41, 26, 470, DateTimeKind.Local).AddTicks(3996),
                            DateHeureOuverture = new DateTime(2024, 2, 9, 15, 41, 26, 470, DateTimeKind.Local).AddTicks(3997),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        });
                });
