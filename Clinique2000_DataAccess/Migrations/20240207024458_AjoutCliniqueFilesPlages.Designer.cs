...
namespace Clinique2000_DataAccess.Migrations
{
    ...
    [Migration("20240207024458_AjoutCliniqueFilesPlages")]
    partial class AjoutCliniqueFilesPlages
    {
            ...
            modelBuilder.Entity("Clinique2000_Models.Models.Clinique", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 7,
                            Adresse = "945 Chemin de Chambly, Longueuil, QC J4H 3M7",
                            CodePostal = "J4H 3M7",
                            Courriel = "clinique2@clinique2000.com",
                            DureeParConsultation = 30,
                            Latitude = 45.535578999999998,
                            Longitude = -73.495116999999993,
                            Nom = "Clinique de la Santé 2",
                            NombreMaximumPatients = 30,
            ...
            modelBuilder.Entity("Clinique2000_Models.Models.FileDAttente", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 2,
                            CliniqueId = 1,
                            DateHeureFermeture = new DateTime(2024, 2, 7, 2, 44, 57, 930, DateTimeKind.Local).AddTicks(5001),
                            DateHeureInscriptions = new DateTime(2024, 2, 6, 18, 44, 57, 930, DateTimeKind.Local).AddTicks(4958),
                            DateHeureOuverture = new DateTime(2024, 2, 6, 21, 44, 57, 930, DateTimeKind.Local).AddTicks(4999),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        },
                        new
                        {
                            Id = 3,
                            CliniqueId = 1,
                            DateHeureFermeture = new DateTime(2024, 2, 7, 21, 44, 57, 930, DateTimeKind.Local).AddTicks(5006),
                            DateHeureInscriptions = new DateTime(2024, 2, 7, 18, 44, 57, 930, DateTimeKind.Local).AddTicks(5002),
                            DateHeureOuverture = new DateTime(2024, 2, 7, 21, 44, 57, 930, DateTimeKind.Local).AddTicks(5004),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        },
                        new
                        ...
                        new
                        {
                            Id = 5,
                            CliniqueId = 7,
                            DateHeureFermeture = new DateTime(2024, 2, 7, 2, 44, 57, 930, DateTimeKind.Local).AddTicks(5014),
                            DateHeureInscriptions = new DateTime(2024, 2, 6, 18, 44, 57, 930, DateTimeKind.Local).AddTicks(5011),
                            DateHeureOuverture = new DateTime(2024, 2, 6, 21, 44, 57, 930, DateTimeKind.Local).AddTicks(5013),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        },
                        new
                        {
                            Id = 6,
                            CliniqueId = 7,
                            DateHeureFermeture = new DateTime(2024, 2, 7, 21, 44, 57, 930, DateTimeKind.Local).AddTicks(5018),
                            DateHeureInscriptions = new DateTime(2024, 2, 7, 18, 44, 57, 930, DateTimeKind.Local).AddTicks(5015),
                            DateHeureOuverture = new DateTime(2024, 2, 7, 21, 44, 57, 930, DateTimeKind.Local).AddTicks(5017),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        });
                });
