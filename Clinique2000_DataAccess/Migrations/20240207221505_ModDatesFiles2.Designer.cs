...
namespace Clinique2000_DataAccess.Migrations
{
    ...
    [Migration("20240207221505_ModDatesFiles2")]
    partial class ModDatesFiles2
    {
            ...
            modelBuilder.Entity("Clinique2000_Models.Models.FileDAttente", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 2,
                            CliniqueId = 1,
                            DateHeureFermeture = new DateTime(2024, 2, 7, 22, 15, 4, 888, DateTimeKind.Local).AddTicks(7690),
                            DateHeureInscriptions = new DateTime(2024, 2, 7, 14, 15, 4, 888, DateTimeKind.Local).AddTicks(7641),
                            DateHeureOuverture = new DateTime(2024, 2, 7, 17, 15, 4, 888, DateTimeKind.Local).AddTicks(7688),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        },
                        new
                        {
                            Id = 3,
                            CliniqueId = 1,
                            DateHeureFermeture = new DateTime(2024, 2, 8, 17, 15, 4, 888, DateTimeKind.Local).AddTicks(7696),
                            DateHeureInscriptions = new DateTime(2024, 2, 8, 14, 15, 4, 888, DateTimeKind.Local).AddTicks(7692),
                            DateHeureOuverture = new DateTime(2024, 2, 8, 17, 15, 4, 888, DateTimeKind.Local).AddTicks(7694),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        },
                        new
                        ...
                        new
                        {
                            Id = 5,
                            CliniqueId = 7,
                            DateHeureFermeture = new DateTime(2024, 2, 7, 22, 15, 4, 888, DateTimeKind.Local).AddTicks(7703),
                            DateHeureInscriptions = new DateTime(2024, 2, 7, 14, 15, 4, 888, DateTimeKind.Local).AddTicks(7699),
                            DateHeureOuverture = new DateTime(2024, 2, 7, 17, 15, 4, 888, DateTimeKind.Local).AddTicks(7701),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        },
                        new
                        {
                            Id = 6,
                            CliniqueId = 7,
                            DateHeureFermeture = new DateTime(2024, 2, 8, 17, 15, 4, 888, DateTimeKind.Local).AddTicks(7708),
                            DateHeureInscriptions = new DateTime(2024, 2, 8, 14, 15, 4, 888, DateTimeKind.Local).AddTicks(7705),
                            DateHeureOuverture = new DateTime(2024, 2, 8, 17, 15, 4, 888, DateTimeKind.Local).AddTicks(7707),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        });
                });
