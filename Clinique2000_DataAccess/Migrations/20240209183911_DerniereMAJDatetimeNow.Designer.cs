...
namespace Clinique2000_DataAccess.Migrations
{
    ...
    [Migration("20240209183911_DerniereMAJDatetimeNow")]
    partial class DerniereMAJDatetimeNow
    {
            ...
            modelBuilder.Entity("Clinique2000_Models.Models.FileDAttente", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 2,
                            CliniqueId = 1,
                            DateHeureFermeture = new DateTime(2024, 2, 9, 18, 39, 11, 293, DateTimeKind.Local).AddTicks(6810),
                            DateHeureInscriptions = new DateTime(2024, 2, 9, 10, 39, 11, 293, DateTimeKind.Local).AddTicks(6774),
                            DateHeureOuverture = new DateTime(2024, 2, 9, 13, 39, 11, 293, DateTimeKind.Local).AddTicks(6808),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        },
                        new
                        {
                            Id = 3,
                            CliniqueId = 1,
                            DateHeureFermeture = new DateTime(2024, 2, 10, 13, 39, 11, 293, DateTimeKind.Local).AddTicks(6816),
                            DateHeureInscriptions = new DateTime(2024, 2, 10, 10, 39, 11, 293, DateTimeKind.Local).AddTicks(6813),
                            DateHeureOuverture = new DateTime(2024, 2, 10, 13, 39, 11, 293, DateTimeKind.Local).AddTicks(6814),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        },
                        new
                        ...
                        new
                        {
                            Id = 5,
                            CliniqueId = 7,
                            DateHeureFermeture = new DateTime(2024, 2, 9, 18, 39, 11, 293, DateTimeKind.Local).AddTicks(6822),
                            DateHeureInscriptions = new DateTime(2024, 2, 9, 10, 39, 11, 293, DateTimeKind.Local).AddTicks(6819),
                            DateHeureOuverture = new DateTime(2024, 2, 9, 13, 39, 11, 293, DateTimeKind.Local).AddTicks(6821),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        },
                        new
                        {
                            Id = 6,
                            CliniqueId = 7,
                            DateHeureFermeture = new DateTime(2024, 2, 10, 13, 39, 11, 293, DateTimeKind.Local).AddTicks(6827),
                            DateHeureInscriptions = new DateTime(2024, 2, 10, 10, 39, 11, 293, DateTimeKind.Local).AddTicks(6824),
                            DateHeureOuverture = new DateTime(2024, 2, 10, 13, 39, 11, 293, DateTimeKind.Local).AddTicks(6826),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        });
                });
